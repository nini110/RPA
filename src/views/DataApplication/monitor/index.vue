	...
	<div class="biddingForMonitoring outerDiv">
		<div class="content">
			<div class="content_form">
				<div class="upobtn">
					<el-button v-waves class="el-icon-upload2" type="primary" @click="upList">上传竞标
					</el-button>
				</div>
			</div>
			<div ref="tableBox" class="content_tableBox jiankong">
				...
				<div class="tables" v-if="tableData">
					<el-table ref="singleTable" class="tableBox" :data="tableData" :highlight-current-row="true"
						:header-cell-style="{background:'#eef0f1',color: '#606266'}">
						<el-table-column type="index" width="100" label="序号" align="center">
						</el-table-column>
						<el-table-column v-for="(item, idx) in tabList" :key="idx" :prop="item.prop" :label="item.label" :min-width="item.width">
						</el-table-column>
						<el-table-column property="cheack" label="操作" fixed="right" width="400">
							<template slot-scope="scope">
								<el-button class="btn btn_info el-icon-edit" type="text"
									@click="detailEvent(scope.row)">
								</el-button>
								<el-button class="btn btn_info iconfont icon-jiaosexiugai" type="text"
									@click="editEvent(scope.row)">
								</el-button>
								<el-button class="btn btn_info iconfont icon-huodongjilu" type="text"
									@click="editActiveEvent(scope.row)">
								</el-button>
								<el-button class="btn btn_delete el-icon-delete" type="text"
