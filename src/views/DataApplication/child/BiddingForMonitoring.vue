<template>
  ...
  <div class="biddingForMonitoring outerDiv">
    <div class="content">
      <div class="form">
        <div class="upobtn">
          <el-button class="btnnormal marginL" type="primary" @click="upList()"
            >上传竞标</el-button
          >
        </div>
      </div>
          ...
          >
            ...
            >
              <template slot-scope="scope">
                <el-button class="el-icon-edit" type="text" @click="detailEvent(scope.row)"
                  >预算</el-button
                >
                <el-button class="el-icon-edit" type="text" @click="editEvent(scope.row)"
                  >人员</el-button
                >
                <el-button class="el-icon-edit" type="text" @click="editActiveEvent(scope.row)"
                  >活动</el-button
                >
                <el-button class="el-icon-delete" type="text" @click="deleteEvent(scope.row)"
                  >删除</el-button
                >
              </template>
            </el-table-column>
