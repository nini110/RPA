<template>
	<!-- 营销人群追踪 -->
	<div class="customAnalysisCreation outerDiv">
		<div class="content">
			<div class="form">
				<el-form ref="form" :model="form" label-width="80px" class="formObj">
					...
					<div class="formObj_button">
						<a class="btnnormal btnnormal_down" href="http://tool.afocus.com.cn/file_download/数坊自动化报告.xlsx" download="数坊自动化报告.xlsx"><div class="btnSize">下载模板</div></a>
