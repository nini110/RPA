<template>
	<!-- 数坊人群交并差集 -->
	<div class="crowdCrossAndMergeDifferenceSet outerDiv">
		<div class="content">
			<div class="form">
				<el-form ref="form" :model="form" label-width="80px" class="formObj">
					...
					<div class="formObj_button">
						<a  class="btnnormal btnnormal_down" href="http://tool.afocus.com.cn/file_download/数坊已有人群集合.xlsx" download="数坊已有人群集合.xlsx"><div class="btnSize">下载模板</div></a>
