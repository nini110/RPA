<template>
	<!-- 自定义分析创建 -->
	<div class="marketingPopulationTracking outerDiv">
		<div class="content">
			<div class="form">
				<el-form ref="form" :model="form" label-width="80px" class="formObj">
					...
					<div class="formObj_button">
							<a class="btnnormal btnnormal_down" href="http://tool.afocus.com.cn/file_download/数坊自定义分析-分析配置项.xlsx" download="数坊自定义分析-分析配置项.xlsx"><div class="btnSizeBig">分析配置项下载</div></a>
							<a class="btnnormal btnnormal_down marginL" href="http://tool.afocus.com.cn/file_download/数坊自定义分析-新建分析.xlsx" download="数坊自定义分析-新建分析.xlsx"><div class="btnSizeBig">新建分析项下载</div></a>						
			...
			<div class="tableBox">
				...
				<div class="tables">
					...
					<div class="tableTab" v-if="tableData">
					  <el-table ref="singleTable" class="tableBox" :data="tableData" size="small" height="540" @cell-click="celltable" :highlight-current-row="true" :cell-style="timeStyle">
					    <!-- 表格序号 -->
					    ...
					    <!-- 查看详情 -->
					    <el-table-column property="cheack" width="120" label="操作">
