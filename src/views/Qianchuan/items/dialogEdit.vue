      ...
      <el-row>
        ...
        <el-col :span="24">
          <el-form-item label="账号类型:" prop="type">
            <el-radio v-model="form.type" label="1" @change="typeChangeEve"
              >店铺</el-radio
            >
            <el-radio v-model="form.type" label="2" @change="typeChangeEve"
              >代理商</el-radio
            >
          </el-form-item>
        </el-col>
        ...
        <el-col :span="24">
          <el-form-item label="千川账号:" prop="quanchuan_id">
            <el-select
              v-model="form.quanchuan_id"
              @change="qcChangeEvent"
              placeholder="请选择千川账号"
        ...
        <el-col :span="24">
          <el-form-item label="抖音账号:" prop="douyin_id">
            <el-select
              v-model="form.douyin_id"
              @change="dyChangeEvent"
              placeholder="请选择抖音账号"
              :disabled="douyinCan"
            >
              <el-option
        ...
        <el-col :span="24">
          <el-form-item label="数据获取间隔:" prop="date"> 5分钟 </el-form-item>
        </el-col>
        <el-col :span="24">
  ...
  methods: {
    ...
    detailEvent(id) {
      ...
      getProjectDetail(
        ...
        vm.timeData = [
          vm.submitData.cast_start_time,
          vm.submitData.cast_end_time,
        ];
    ...
    tabEvent(val) {
      ...
      Promise.all([
        strategyList(data),
        budgetStrategyList(data),
        planStrategyList(data),
      ]).then((res) => {
