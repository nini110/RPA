			...
			<el-row>
				...
				<el-col>
					<el-form-item label="次数:" prop="count" class="oneIpt">
						<el-input-number v-model="form.count" :min="1" label="描述文字" size="medium" clearable>
						</el-input-number> 次
					</el-form-item>
				</el-col>
				<el-col>
					<el-form-item label="条件:" prop="condition" class="twoIpt">
						<el-select v-model="form.condition" placeholder="请选择" size="medium" clearable>
							<el-option v-for="item in conditionOpt" :key="item.value" :label="item.label"
								:value="item.value">
							</el-option>
						</el-select>
				...
				<el-col>
					<el-form-item label="出价:" prop="bid_operate" class="twoIpt">
						<el-select v-model="form.bid_operate" placeholder="请选择" size="medium" clearable>
							<el-option v-for="item in bidOpt" :key="item.value" :label="item.label" :value="item.value">
							</el-option>
						</el-select>
						<el-input-number v-model="form.bid_proportion" :min="1" :max="50" size="medium" label="描述文字"
							clearable>
						</el-input-number> %
					</el-form-item>
				</el-col>
