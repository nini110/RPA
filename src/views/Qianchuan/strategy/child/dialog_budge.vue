	...
	<el-dialog :title="diaTxt" :visible.sync="dialogVisible" custom-class="dialogEdit dialogStrategy"
		...
		<el-form ref="form" :model="form" :rules="rules">
			...
			<el-form-item label="预算:" prop="budget_operate" class="twoIpt">
				<el-select v-model="form.budget_operate" placeholder="请选择" size="medium">
					<el-option v-for="item in budgetOptions" :key="item.value" :label="item.label" :value="item.value">
					</el-option>
				</el-select>
				<el-input-number v-model="form.budget_money" :min="100" :max="2000" size="medium" label="描述文字">
				</el-input-number>元
			</el-form-item>
		</el-form>
