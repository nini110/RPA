	...
	<div class="age strategyNormal">
		<div class="centers">
			...
			<div class="dialog ageDialog">
				<el-dialog title="年龄模板" :visible.sync="dialogVisible" custom-class="dialogEdit dialogStrategy"
					...
					<el-form ref="form" :model="form" :rules="rules">
						...
						<el-form-item label="年龄:" prop="name">
							<el-checkbox-group v-model="form.age" @change="handleCheckedCitiesChange">
								<el-checkbox v-for="city in cities" :label="city.value" :key="city.value">
