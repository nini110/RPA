<template>
	<el-dialog :title="diaTxt" :visible.sync="dialogVisible" custom-class="dialogStrategy ageDialog" :close-on-click-modal="false"
		width="30%" @close="closeEvent">
		<el-form ref="form" :model="form" :rules="rules">
			...
			<el-form-item label="年龄:" prop="age">
				<el-checkbox-group v-model="form.age" @change="handleCheckedCitiesChange">
					<el-checkbox v-for="item in ageOptions" :label="item.value" :key="item.value">
						{{ item.lable }}
					</el-checkbox>
				</el-checkbox-group>
			</el-form-item>
