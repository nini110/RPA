  ...
  <div class="realTime outerDiv">
    <div class="content">
        ...
        <el-form ref="form" :model="form" class="formObj">
          <div class="formObj_ipt">
            <el-form-item label="策略名称:">
              <el-input v-model="input" size="medium" placeholder="请输入策略名称" clearable></el-input>
            </el-form-item>
            ...
            <el-form-item label="计划名称:">
              <el-input v-model="input" size="medium" placeholder="请输入计划名称" clearable></el-input>
            </el-form-item>
          </div>
          <div class="formObj_button">
            <el-button type="primary" class="btnnormal" size="small">查询</el-button>
          </div>
        </el-form>
      </div>
      <div ref="tableBox" class="tableBox">
        ...
        <div class="tables">
          <div class="dialog">
            <el-dialog title="更换模板" :visible.sync="dialogVisible" width="30%" :close-on-click-modal="false">
              <el-form ref="form" :model="form" label-width="120px">
                <el-form-item label="计划名称:">
                  <el-input v-model="form.name" placeholder="请输入计划名称" size="medium" class="w240">
                  </el-input>
                </el-form-item>
                <el-form-item label="地域模板:">
                  <el-select v-model="form.region" placeholder="请选择活动区域" size="medium" class="w240">
                    <el-option label="区域一" value="shanghai"></el-option>
                    <el-option label="区域二" value="beijing"></el-option>
                  </el-select>
                </el-form-item>
                <el-form-item label="年龄模板">
                  <el-select v-model="form.age" placeholder="请选择活动区域" size="medium" class="w240">
                    <el-option label="区域一" value="shanghai"></el-option>
                    <el-option label="区域二" value="beijing"></el-option>
                  </el-select>
                </el-form-item>
          ...
          <div class="tableTab">
            <el-table class="tableBox" border :data="tableData" :height="tableHeight">
              <template slot="empty">
                <span class="iconfont icon-wushuju">暂无数据</span>
              </template>
              <el-table-column type="index" label="序号" width="100" align="center" header-align="center" fixed="left">
              </el-table-column>
              <el-table-column prop="create_time" label="策略执行时间" width="180">
              </el-table-column>
              <el-table-column prop="strategy_name" label="撞线策略" width="180">
              </el-table-column>
              <el-table-column prop="address1" label="类型">
              ...
              <el-table-column prop="plan_name" label="计划名称" width="260">
                <template slot="header">
                  计划名称
                  <el-tooltip class="item" effect="light" content="目前暂不支持拉取开启“计划托管”功能的广告计划数据" placement="top">
              ...
              <el-table-column prop="address4" label="调整内容" width="120">
                <template slot-scope="scope">
  ...
  methods: {
    ...
    readTimeData () {
      ...
      let params = {
        ...
        project_id: vm.$route.query.id,
      };
      readTimeData(params)
        .then((res) => {
          if (res.data.data.total_count !== 0) {
            vm.tableData = res.data.data;
            vm.total = res.data.total_count;
          } else {
