...
JDJRValidate.prototype = {
    ...
    initClickWrap: function() {
        ...
        function b() {
            if (!c.clickResult) {
                if (c.params.product == "click-popup" || c.params.product == "e-pic-popup") {
    ...
    bindPicClickEvent: function() {
        ...
        if (d.params.product == "e-pic-popup") {
            if (d.params.eventListener == false || d.params.eventListener == "false") {
                d.verify = function() {
                    d.warp.style.display = "block";
                    d.resetSize()
                }
            } else {
                document.getElementById(d.params.id).onclick = function() {
                    d.warp.style.display = "block";
                    d.resetSize()
                }
            }
    ...
    resetSize: function() {
        ...
        if (d.params.product == "bind" || d.params.product == "popup" || d.params.product == "click-popup" || d.params.product == "e-pic-popup") {
            d.popContent.style.marginLeft = d.popContent.offsetWidth < 360 ? (document.body.clientWidth * (-0.432) + "px") : (d.popContent.offsetWidth / 2 * -1 + "px")
        }
        ...
        if (d.params.product == "e-pic-popup" && d.picClickWrap) {
            this.width = this.picClickWrap.offsetWidth;
            this.picClickBigImg.style.height = 333 / (640 / this.picClickWrap.offsetWidth) + "px"
        }
    },
    ...
    getValidateImage: function() {
        ...
        a.jsonp(a.apiServer + "/slide/g.html", {
            ...
            if (a.params.product != "click" && a.params.product != "click-bind" && a.params.product != "suspend" && a.params.product != "bind-suspend" && a.params.product != "dsc" && a.params.product != "i-dsc" && a.params.product != "pic-click" && a.params.product != "i-pic-click" && a.params.product != "e-pic-popup") {
                a.slideBigImg.innerHTML = '<img src="' + a.getImgSrc(b.static_servers, b.bg) + '">';
                a.slideSmallImg.innerHTML = '<img src="' + a.getImgSrc(b.static_servers, b.patch) + '">';
                a.y = b.y;
                ...
                if (a.params.product == "dsc" || a.params.product == "i-dsc") {
                    a.dscBigImg.innerHTML = '<img src="' + a.getImgSrc(b.static_servers, b.bg) + '">';
                    a.questionLable.innerHTML = b.desc
                } else {
                    if (a.params.product == "pic-click" || a.params.product == "i-pic-click" || a.params.product == "e-pic-popup") {
                        a.picClickBigImg.innerHTML = '<img src="' + a.getImgSrc(b.static_servers, b.bg) + '">';
                        a.questionLable.innerHTML = b.desc + '<img src="' + a.getImgSrc(b.static_servers, b.cp) + '">';
                        a.operLimit = b.n;
    ...
    submit: function() {
        ...
        h.jsonp(h.apiServer + "/slide/s.html", {
            d: h.getCoordinate(g),
            c: h.validateID,
            ...
            if (h.params.product == "click" || h.params.product == "click-bind" || h.params.product == "suspend" || h.params.product == "bind-suspend") {
                ...
                if (h.params.product == "dsc" || h.params.product == "i-dsc") {
                    ...
                    if (h.params.product == "pic-click" || h.params.product == "i-pic-click" || h.params.product == "e-pic-popup") {
                        ...
                        if (k.success == 0) {
                            ...
                            setTimeout(function() {
                                if (h.params.product == "i-pic-click" || h.params.product == "e-pic-popup") {
            ...
            if (h.params.product == "click" || h.params.product == "click-bind") {
                ...
                if (h.params.product == "dsc") {
                    ...
                    if (h.params.product == "pic-click" || h.params.product == "i-pic-click" || h.params.product == "e-pic-popup") {
                        ...
                        h.mousePos = new Array();
                        for (var d = 0; d < h.operSeqs.length; d++) {
                            h.operSeqs[d].style.display = "none"
                        }
                        if (h.params.product == "i-pic-click") {
                            h.params.product = data.nextVerify == "SLIDE_VERIFY" ? "click-bind-suspend" : "i-pic-click"
                        }
                        setTimeout(function() {
                            if (h.params.product == "i-pic-click" || h.params.product == "e-pic-popup") {
                                h.picClickResult.style.display = "none";
