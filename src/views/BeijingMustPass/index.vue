...
<div style="height: 100%">
  <IptComp ref="iptcomp" :formMenu="1" :picSrc="picSrc" :ifDown="ifDown" :colWidth="colWidth" :toolType="toolType" :sheetName="sheetName" :excelOptions="excelOptions">
  </IptComp>
</div>
</template>
                ...
                // 人群名称
                {
                  ...
                  v: {
                    ...
                    ps: {
                      ...
                      width: 91, //批注框宽度
                      height: 48, //批注框高度
                      value: "1.目前默认只支持DMP自建人群 2. 多个人群的话需要使用‘｜’隔开", //批准内容
                      isshow: false, //批注框为显示状态
                    },
                  },
                },
                // 操作类型
                {
                  ...
                  v: {
                    ...
                    ps: {
                      ...
                      width: 91, //批注框宽度
                      height: 48, //批注框高度
                      value: "1.只替换创意时此项必填 2.默认为空，即为新增单元  3.当更新创意时单元名称、媒体类型、计划名称、创意名称必填，其他不填写", //批准内容
                      isshow: false, //批注框为显示状态
                    },
                  },
                },
                // 创意名称
                {
                  ...
                  v: {
                    ...
                    ps: {
                      ...
                      width: 91, //批注框宽度
                      height: 48, //批注框高度
                      value: "1.不能为空 2.可填写多个，多个创意名称必须使用‘｜’隔开， 例如：创意1｜创意2", //批准内容
                      isshow: false, //批注框为显示状态
                    },
                  },
                },
                ...
                // 起止时间
                {
                  ...
                  v: {
                    ...
                    ps: {
                      ...
                      width: 91, //批注框宽度
                      height: 48, //批注框高度
                      value: "1.只有腾讯资源，且非京东定向必填  2.落地页类型及跟单SKU必填", //批准内容
                      isshow: false, //批注框为显示状态
                    },
                  },
                },
                ...
                // 媒体资源
                {
                  ...
                  v: {
                    ...
                    ps: {
                      ...
                      width: 91, //批注框宽度
                      height: 48, //批注框高度
                      value: "填写微信-朋友圈；抖音；京东联盟等， 如计划属于头条新京东定向，这里填写今日头条（新）或 抖音（新）", //批准内容
                      isshow: false, //批注框为显示状态
                    },
                  },
                },
