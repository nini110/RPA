        ...
        >
          <el-carousel-item v-for="(item, idx) in homeMenu" :key="idx">
            <ul class="home_menu_right" :class="{ active: hoverFlag === idx }">
              ...
              <li
                v-for="(item1, idx1) in item.child"
                :key="idx1"
                class="normal"
                @click="routerLink"
                @mouseover="suboverevent(item1)"
              >
                <div>
          ...
          child: [
            {
              title: "灵鲨制表",
              class: "",
              url: "/layout/dataApplication/tabulation",
            ...
            },
            {
              title: "桑基图数据",
              class: "",
              url: "/layout/dataApplication/snake",
