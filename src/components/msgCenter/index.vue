<template>
<el-dialog title="信息中心" custom-class="noticeDialog" :visible.sync="dialogVisible" width="43%" :close-on-click-modal="false" :close-on-press-escape="false" append-to-body modal-append-to-body @close="closeDialog">
    ...
    <div class="adInoDialog_right msgDialog_right">
      ...
      <div v-else>
        ...
        <div class="adInoDialog_body">
          ...
          <div class="part">
            <p v-for="(item1, idx1) in partList[currentPart].mail_content_arr" :key="idx1">
        ...
        <div class="adInoDialog_btn">
          <el-button type="danger" plain round @click="closeEvent(partList[currentPart])">我已知晓</el-button>
